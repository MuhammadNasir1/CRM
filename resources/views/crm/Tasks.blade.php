  ...
  <div class="main-con" style="height:100vh">
    <nav class="navbar task-nav navbar-expand-lg bg-transparent">
      <div class="container-fluid">
        <a class=" ms-4 nav-heading navbar-brand" href="#">My Tasks</a>
        ...
        <form class="d-flex" role="search">
          ...
          <ul class="dropdown-menu others-dropdown">
            ...
            <li>
              <a class="dropdown-item" href="#"><i class='bx bx-network-chart'></i> Folder</a>
            </li>
            <li>
              <a class="dropdown-item" href="#"><i class='bx bx-folder'></i> Workflows</a>
            </li>
            <li>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="task-add-btn mt-3 ">
          <button type="button" class=" float-end">Add Task </button>
        </div>
      </div>
    </div>
    <!-- =========== -->
        ...
        <div class="daily-tasks">
          ...
          <div class="daily-task">
            <span>
              ...
              <span class="ms-1">Task 1</span>
            </span>
            <p class="float-end pt-1 ">Feb 16
              <span class="ms-3">In progress</span>
            </p>
          </div>
          <div class="daily-task">
            <span>
              <img src="./images/Rectangle 17.svg" alt="image">
              <span class="ms-1">Task 2</span>
            </span>
            <p class="float-end pt-1 ">Feb 16
              <span class="ms-3">In progress</span>
            </p>
